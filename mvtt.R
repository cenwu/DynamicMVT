...
#  Simulation of mvtt. mvtt.r: Data have been generated by using multivariae t distribution, and then fitted by mixture model with multivariate t assumption.
